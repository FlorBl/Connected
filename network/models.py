...
class User(AbstractUser):
    ...
    cover_image = models.ImageField(null=True, blank=True, upload_to="cover/",default="cover/mars.jpg")
    bio = models.CharField(max_length=140, blank=True,default='Hello, im new!')
